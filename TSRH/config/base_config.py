...
class Config(ABC):
    def __init__(self):
        ...
        # add hash parameters
        self.num_images_generated = args.num_images_generated
        self.generated_images_dir = args.generated_images_dir
        self.use_QwenDiffusion_geneimages = args.use_QwenDiffusion_geneimages
        self.threshold = args.threshold
        self.weight_name = args.weight_name
        self.hash_bit = args.hash_bit
        self.didemo_txt_path = args.didemo_txt_path
        self.baseline_n = args.baseline_n
