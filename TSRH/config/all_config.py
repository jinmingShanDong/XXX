...
class AllConfig(Config):
    ...
    def parse_args(self):
        ...
        parser.add_argument('--exp_name', type=str,default="",required=True, help="Name of the current experiment")
        parser.add_argument('--output_dir', type=str, default='./outputs')
        parser.add_argument('--save_every', type=int, default=1, help="Save model every n epochs")
        parser.add_argument('--log_step', type=int, default=10, help="Print training log every n steps")
        parser.add_argument('--log_name', type=str, default='log_1.txt', help="the name of log file")
        ...
        parser.add_argument('--metric', type=str, default='t2v', help="'t2v'/'v2t'/map_t2v/map_v2t'")

        # model parameters
        parser.add_argument('--huggingface', default=False)
        ...
        parser.add_argument('--noclip_lr', type=float, default=1e-5, help='Learning rate used for new params') # 1e-3
        ...
        parser.add_argument('--pooling_type', type=str, default='meanPool')
        ...
        # add hash parameters
        parser.add_argument('--num_images_generated', type=int, default=12, help='Use the number of images generated:1--12')
        parser.add_argument('--generated_images_dir', type=str, default='data/MSRVTT/vids', help="The generated image directory.")
        parser.add_argument('--threshold', type=int, default=0.0, help='Using thresholds, the hash is mapped to 1 and -1.')
        parser.add_argument('--use_QwenDiffusion_geneimages', type=bool, default=False, help='Do you use images generated by Qwen?')
        parser.add_argument('--hash_bit', type=int, default=512, help='hash length.')
        parser.add_argument('--didemo_txt_path', type=str, default="/data/home/jinming/all_data/DiDeMo", help="")
        parser.add_argument('--baseline_n', type=str, default="Our", help="Our,baseline_2023_1,baseline_2024_1")
       



        # base_CLIP；base_CLIP_add_T2Vattention;base_CLIP_add_T2Vattention_V2Tattention;base_CLIP_add_T2Vattention_V2Tattention_gru
        # base_CLIP_add_T2Vattention_V2Tattention_Qwen
        parser.add_argument('--weight_name', type=str, default='base_CLIP_add_T2Vattention_V2Tattention_Qwen', help='Change the weight name.pth')

        args = parser.parse_args()

        args.model_path = os.path.join(args.output_dir, args.exp_name) # 这个就是模型参数保存的路径
